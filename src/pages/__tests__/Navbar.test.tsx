...
describe('Navbar', () => {
  ...
  test('toggles menu when hamburger is clicked', async () => {
    ...
    const navMenu = screen.getByRole('navigation').querySelector('.navbar-collapse');
    expect(navMenu?.className).toContain('collapse');

    await userEvent.click(toggleButton);
    expect(navMenu?.className).not.toContain('collapse');
