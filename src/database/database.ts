...
export const destinationsHome: DestinationHome[] = [
  {
    ...
    altText: 'Beach',
    titleKey: 'destination_title_1',
    descriptionKey: 'destination_description_1'
  },
  {
    id: 2,
    title: 'Mountains',
    ...
    altText: 'Mountains',
    titleKey: 'destination_title_2',
    descriptionKey: 'destination_description_2'
  },
  {
    id: 3,
    title: 'Iconic Cities',
    ...
    altText: 'Cities',
    titleKey: 'destination_title_3',
    descriptionKey: 'destination_description_3'
  }
];
...
export const destinations: Destination[] = [
  {
    ...
    titleKey: "destination_title_4",
    descriptionKey: "destination_description_4"
  },
  {
    id: 2,
    ...
    titleKey: "destination_title_5",
    descriptionKey: "destination_description_5"
  },
  {
    id: 3,
    title: "Vibrant City",
    ...
    titleKey: "destination_title_6",
    descriptionKey: "destination_description_6"
  },
  {
    id: 4,
    title: "Desert Oasis",
    ...
    titleKey: "destination_title_7",
    descriptionKey: "destination_description_7"
  },
  {
    id: 5,
    ...
    titleKey: "destination_title_8",
    descriptionKey: "destination_description_8"
  },
  {
    id: 6,
    title: "Lake Serena",
    ...
    titleKey: "destination_title_9",
    descriptionKey: "destination_description_9"
  }
];
...
export const packagesHome: PackageHome[] = [
  {
    ...
    titleKey: 'package_title_1',
    descriptionKey: 'package_description_1'
  },
  {
    id: 2,
    title: 'Family Package',
    description: 'Guaranteed fun for the whole family in unique destinations.',
    titleKey: 'package_title_2',
    descriptionKey: 'package_description_2'
  }
];
...
export const teamMembers: TeamMember[] = [
  {
    ...
    roleKey: "team_member_role_1",
    descriptionKey: "team_member_description_1"
  },
  {
    id: 2,
    name: "Mary Costa",
    ...
    roleKey: "team_member_role_2",
    descriptionKey: "team_member_description_2"
  },
  {
    id: 3,
    name: "Charles Souza",
    ...
    roleKey: "team_member_role_3",
    descriptionKey: "team_member_description_3"
  }
];
